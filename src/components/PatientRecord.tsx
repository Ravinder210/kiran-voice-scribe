...
import { ArrowLeft, FileText, Pill, History, Paperclip, Mic, Square, Save } from 'lucide-react';
...
const PatientRecord = ({ patient, onBack }: PatientRecordProps) => {
  ...
  const generateSampleClinicalNotes = () => {
    ...
    // Switch to clinical note tab to show generated content
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="mb-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 sm:gap-8">
            {/* Simplified Patient Info Sidebar */}
              ...
              <Card className="border-purple-200">
                <CardContent className="p-4 sm:p-6">
                  <div className="text-center mb-6">
                    ...
                    <p className="text-gray-600 text-xs sm:text-sm hidden sm:block">{patient.specialty}</p>
                  </div>
                  ...
                  <div className="mt-6 p-4 bg-gradient-to-r from-purple-500 to-blue-500 rounded-lg text-white">
                    ...
                    {isProcessing && (
                      <div className="mt-2 flex items-center justify-center">
                        ...
                        <span className="text-xs">AI processing voice...</span>
                      </div>
                    )}
                  </div>
                </CardContent>
